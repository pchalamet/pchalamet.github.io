...
C# has a `?.` operator but F# has not. Probably considering F# pipelining capabilities. Null-coalescing would be welcome but probably can be solved with a custom function.
